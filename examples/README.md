...
- `evaluations/openai_draft_eval/eval_summary.md` summarizes the checked-in AI drafting evaluation.
- `live_openai_trace/langsmith_trace_summary.md` explains the compact live OpenAI trace evidence kept in the repo.

## Technical Evidence

- `workshop_bulletin_run/request_evidence.json` and `normalized_request.json` show the input evidence and normalized workflow state.
- `workshop_bulletin_run/draft_output.json`, `policy_decision.json`, `publication_packet.json`, `trace.json`, and `run_summary.json` show how the packet was produced.
