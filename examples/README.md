...
- `evaluations/openai_draft_eval/eval_summary.md` explains the three checked-in AI interpretation and drafting eval cases before the backing JSON.
...
- `workshop_bulletin_run/request_evidence.json`, `request_interpretation.json`, and `normalized_request.json` show the input evidence, interpreted evidence, and normalized workflow state.
